            ...
            $('h1').click(function() {
                ...
                $(this).next('#k').slideDown('fast');
					...
					$("#divResult").fadeIn(2000,function()
							...
							$("#divResult2").html("<p>♥ Dù gì t cũng có lỗi thật, làm m giận. Nhưng m bỏ qua r thì làm bạn thân lại nha.<img src='http://website1gia.com/files/assets/4.png'/></p></br>");
							$("#divResult2").fadeIn(2000,function()
									{
									$("#divResult3").fadeOut(0);
									$("#divResult3").html("<p>Mốt về Củ Chi t bao m đi ăn bò né =))  <img src='https://i.imgur.com/OfgQ3o3.png'/></p></br>");
